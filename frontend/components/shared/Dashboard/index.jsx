...
const Dashboard = ({ data }) => {
  ...
  const totalTransaction = data?.totalTransaction ?? 0;
      ...
      <div className="grid md:grid-cols-4 gap-6">
        ...
        <Card className="shadow">
          <div className="flex justify-around items-center">
            ...
            <Divider type="vertical" className="h-24" />
            <div>
              <h1 className="text-3xl font-bold text-rose">{totalTransaction} T</h1>
              <p className="text-lg mt-1 text-Zinc-400">
                {Math.floor(totalTransaction + (totalTransaction * 50) / 100)}
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="shadow">
          <div className="flex justify-around items-center">
            ...
            <Divider type="vertical" className="h-24" />
            <div>
              <h1 className="text-3xl font-bold text-green">{totalcredit} T</h1>
              <p className="text-lg mt-1 text-Zinc-400">
                {Math.floor(totalcredit + (totalcredit * 50) / 100)}
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="shadow">
          <div className="flex justify-around items-center">
            ...
            <Divider type="vertical" className="h-24" />
            <div>
              <h1 className="text-3xl font-bold text-orange">{totalDebit} T</h1>
              <p className="text-lg mt-1 text-Zinc-400">
                {Math.floor(totalDebit + (totalDebit * 50) / 100)}
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="shadow">
          <div className="flex justify-around items-center">
            ...
            <Divider type="vertical" className="h-24" />
            <div>
              <h1 className="text-3xl font-bold text-blue">{balance} T</h1>
              <p className="text-lg mt-1 text-Zinc-400">
                {Math.floor(balance + (balance * 50) / 100)}
              </p>
            </div>
          </div>
        </Card>
